...
java -jar "target/ea2rdf-0.1.0-jar-with-dependencies.jar" -e input/example.eap > output/export.ttl
...
#java -jar "target/ea2rdf-0.1.0-jar-with-dependencies.jar" -e local/zvg.EAP > output/zvg.ttl
